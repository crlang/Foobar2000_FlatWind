...
function formatPlaylistTotalDurationText(seconds) {
    ...
    if(DURATION.seconds > 0) {
        if (Math.floor(DURATION.seconds / 604800) > 0) {
            ...
            DURATION.text = DURATION.weeks + (DURATION.weeks > 1 ? " 周" : " 周");
        };
        if (Math.floor(DURATION.seconds / 86400) > 0) {
            ...
            if(DURATION.text.length > 0) {
                DURATION.text = DURATION.text + " " + DURATION.days + (DURATION.days > 1 ? " 天" : " 天");
            }; else {
                DURATION.text = DURATION.days + (DURATION.days > 1 ? " 天" : " 天");
            };
        };
        if (Math.floor(DURATION.seconds / 3600) > 0) {
            ...
            if(DURATION.text.length > 0) {
                DURATION.text = DURATION.text + " " + DURATION.hours + (DURATION.hours > 1 ? " 小时" : " 小时");
            }; else {
                DURATION.text = DURATION.hours + (DURATION.hours > 1 ? " 小时" : " 小时");
            };
        };
        if (Math.floor(DURATION.seconds / 60) > 0) {
            ...
            if(DURATION.text.length > 0) {
                DURATION.text = DURATION.text + " " + DURATION.minutes + (DURATION.minutes > 1 ? " 分" : " 分");
            }; else {
                DURATION.text = DURATION.minutes + (DURATION.minutes > 1 ? " 分" : " 分");
            };
        };
        if(DURATION.text.length > 0) {
			if(Math.ceil(DURATION.seconds) > 0) {
				DURATION.text = DURATION.text + " " + Math.ceil(DURATION.seconds) + (Math.ceil(DURATION.seconds) > 1 ? " 秒" : " 秒");
			};
        }; else {
            DURATION.text = Math.ceil(DURATION.seconds) + (Math.ceil(DURATION.seconds) > 1 ? " 秒" : " 秒");
        };
    };
